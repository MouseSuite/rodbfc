...
## Training the model
A pretrained model is included in ```models``` directory. If you want to train a new model, you can use the ```main_training.py``` after modifying it appropriately with your data path. 
